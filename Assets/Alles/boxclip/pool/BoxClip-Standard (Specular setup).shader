...
Shader "Hidden/BoxClipBaked/2e15c8851a9a96f429bbfa61eaeef332Inst/Standard (Specular setup)" {
CGINCLUDE
    ...
    #define boxQuad_ClipShow_Count 0
    #define DECLARE_BOXCLIP_ClipShow_ARRAY static internalBoxQuad boxQuad_ClipShow_Quads[1] = {\
