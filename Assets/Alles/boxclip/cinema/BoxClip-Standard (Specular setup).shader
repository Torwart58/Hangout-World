...
Shader "Hidden/BoxClipBaked/025b1e3d8d5a39a418b5a6b2ecb163edInst/Standard (Specular setup)" {
CGINCLUDE
    ...
    #define DECLARE_BOXCLIP_ClipShow_ARRAY static internalBoxQuad boxQuad_ClipShow_Quads[4] = {\
        {float3(-1.35,0.15,-2.349998),float4(0,0,-1,0.001),float4(0,1,0,0.5),float4(1,0,0,0.7692308)},\
        {float3(-0.04999983,0.15,-0.9499969),float4(0,0,1,0.001),float4(0,1,0,0.5),float4(-1,0,0,0.7692308)},\
        {float3(1.192093E-07,0.15,-2.299999),float4(1,0,1.192093E-07,0.001),float4(0,1,0,0.5),float4(-1.192093E-07,0,1,0.7692296)},\
        {float3(-1.399999,0.0999999,-1.049995),float4(-1,0,1.192093E-07,0.001),float4(0,1,0,0.5),float4(-1.192093E-07,0,-1,0.7692296)}\
};
    ...
    #define DECLARE_BOXCLIP_ZCompress_ARRAY static internalBoxQuad boxQuad_ZCompress_Quads[4] = {\
        {float3(-1.35,0.15,-2.349998),float4(0,0,-1,0.001),float4(0,1,0,0.5),float4(1,0,0,0.7692308)},\
        {float3(-0.04999983,0.15,-0.9499969),float4(0,0,1,0.001),float4(0,1,0,0.5),float4(-1,0,0,0.7692308)},\
        {float3(1.192093E-07,0.15,-2.299999),float4(1,0,1.192093E-07,0.001),float4(0,1,0,0.5),float4(-1.192093E-07,0,1,0.7692293)},\
        {float3(-1.399999,0.0999999,-1.049995),float4(-1,0,1.192093E-07,0.001),float4(0,1,0,0.5),float4(-1.192093E-07,0,-1,0.7692293)}\
};
