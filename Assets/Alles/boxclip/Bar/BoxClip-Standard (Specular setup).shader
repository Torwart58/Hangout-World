...
Shader "Hidden/BoxClipBaked/0233215de288f574089a55bd1ac9b3faInst/Standard (Specular setup)" {
CGINCLUDE
    ...
    #define DECLARE_BOXCLIP_ClipShow_ARRAY static internalBoxQuad boxQuad_ClipShow_Quads[4] = {\
        {float3(1.549998,-0.8,2.4),float4(3.330675E-16,0,1,0.001),float4(0,1,0,0.5),float4(-1,0,3.279439E-15,0.7692298)},\
        {float3(0.299994,-0.7499999,0.9999998),float4(2.384186E-07,0,-1,0.001),float4(0,1,0,0.5),float4(1,0,2.384186E-07,0.7692298)},\
        {float3(1.649996,-0.7499999,1.05),float4(1,0,1.192093E-07,0.001),float4(0,1,0,0.5),float4(-1.192093E-07,0,1,0.7692307)},\
        {float3(0.2499945,-0.7499999,2.35),float4(-1,0,-1.192093E-07,0.001),float4(0,1,0,0.5),float4(1.192093E-07,0,-1,0.7692307)}\
};
