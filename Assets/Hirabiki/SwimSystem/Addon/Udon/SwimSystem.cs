namespace Hirabiki.Udon.Works
{
    ...
    public class SwimSystem : UdonSharpBehaviour
    {
        ...
        [SerializeField] private SwimLocomotion swimLocomotion;
        ...
        void FixedUpdate()
        {
            ...
            swimLocomotion.swimEnergy = simIki < 0f ? Mathf.Lerp(0.0f, Mathf.Lerp(0.666666666f, 1f, KuukiRatio()), CombatHPRatio()) : 1f;
            Vector3 inputVector = swimLocomotion.GetSwimVector() * swimLocomotion.swimEnergy;

            // TODO: Apply sinking force to locomotion
            swimLocomotion.buoyancyRatio = Mathf.Lerp(0.25f, 1.00f, KuukiRatio());
